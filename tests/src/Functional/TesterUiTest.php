 ...
 * @group legacy
 */
class TesterUiTest extends BrowserTestBase {
   ...
   *
   * @expectedDeprecation Drupal\tester\TestDiscovery is deprecated in drupal:8.8.0 and is removed from drupal:9.0.0. Use \Drupal\Core\Test\TestDiscovery instead. See https://www.drupal.org/node/2949692
   */
  public function testTestingThroughUI() {
    ...
    $this->assertTrue(strpos($settings['tester']['images'][0], 'core/misc/menu-collapsed.png') > 0, 'drupalSettings contains a link to core/misc/menu-collapsed.png.');
