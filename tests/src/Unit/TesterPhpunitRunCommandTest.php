...
/**
 * Tests tester_run_phpunit_tests() handles PHPunit fatals correctly.
 *
 * We don't extend \Drupal\Tests\UnitTestCase here because its $root property is
 * not static and we need it to be static here.
 *
 * The file tester_phpunit_run_command_test.php contains the test class
 ...
 */
class TesterPhpunitRunCommandTest extends TestCase {
  ...
  public static function setUpBeforeClass() {
    ...
    // tester_phpunit_run_command_test.php.
    include_once self::$root . '/core/modules/simpletest/tests/fixtures/tester_phpunit_run_command_test.php';
    // Since we're testing tester_run_phpunit_tests(), we need to include
    // simpletest.module.
   ...
   *
   * @covers ::tester_run_phpunit_tests
   *
   * @dataProvider provideStatusCodes
   *
   * @expectedDeprecation tester_run_phpunit_tests is deprecated in drupal:8.8.0 and is removed from drupal:9.0.0. Use \Drupal\Core\Test\PhpUnitTestRunner::runTests() instead. See https://www.drupal.org/node/2948547
   * @expectedDeprecation tester_phpunit_xml_filepath is deprecated in drupal:8.8.0 and is removed from drupal:9.0.0. Use \Drupal\Core\Test\PhpUnitTestRunner::xmlLogFilepath() instead. See https://www.drupal.org/node/2948547
   */
  public function testSimpletestPhpUnitRunCommand($status, $label) {
    ...
    // Test against tester_run_phpunit_tests().
    $bc_ret = tester_run_phpunit_tests($test_id, [SimpletestPhpunitRunCommandTestWillDie::class]);
    ...
    unlink(tester_phpunit_xml_filepath($test_id));
  }
